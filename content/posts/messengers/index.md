...
Signal requires a phone number for registration and use.  This raises a valid privacy concern for some people who do not want to share their phone number to be able to message someon. 

This is where [Signal usernames](https://support.signal.org/hc/en-us/articles/6712070553754-Phone-Number-Privacy-and-Usernames) come in. Signal usernames allow you to create a username that can be shared in place of a phone number for someone to message you. By default, your phone number is hidden from people you message. 
